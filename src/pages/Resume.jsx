...
export default function Resume() {
  ...
  const handleDownload = () => {
    if (selectedIndex === 0) {
      ...
      a.href = '/resume/aenun akhkam.pdf'
      a.download = 'aenun akhkam.pdf'
      document.body.appendChild(a)
      a.click()
      document.body.removeChild(a)
    } else {
      const a = document.createElement('a')
      a.href = '/resume/matanet.png'
      a.download = 'matanet.png'
      document.body.appendChild(a)
      a.click()
      document.body.removeChild(a)
    }
  ...
  const handleView = () => {
    if (selectedIndex === 0) {
      window.open('/resume/aenun akhkam.pdf', '_blank')
    } else {
      window.open('/resume/matanet.png', '_blank')
    }
  }
